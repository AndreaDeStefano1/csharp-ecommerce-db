...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.Property<int>("OrdersPlacedOrderId")
                        .HasColumnType("int");

                    b.Property<int>("ProductsInOrderProductId")
                        .HasColumnType("int");

                    b.HasKey("OrdersPlacedOrderId", "ProductsInOrderProductId");

                    b.HasIndex("ProductsInOrderProductId");
            ...
            modelBuilder.Entity("OrderProduct", b =>
                {
                    b.HasOne("csharp_ecommerce_db.Order", null)
                        .WithMany()
                        .HasForeignKey("OrdersPlacedOrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
